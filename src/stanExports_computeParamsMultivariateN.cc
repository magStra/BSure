...
#include "stanExports_computeParamsMultivariateN.h"

RCPP_MODULE(stan_fit4computeParamsMultivariateN_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_computeParamsMultivariateN")

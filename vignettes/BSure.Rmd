...
<em>proportion_genes_recovered </em>is the proportion of essential genes of types I and II from the gold standard set (FDR 0.1 for both types) that are also contained in the corresponding set for the new screen. The closer to one, the better the two screens agree in identifying genes at different essentiality types. 
